    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden" style={{ background: '#2A180A' }}>
      ...
      <div className="relative z-10 w-full max-w-[400px] animate-fade-up">
        ...
        <div className="text-center mb-8">
          <h1 className="text-5xl sm:text-6xl font-black text-amber-200/90 tracking-tight drop-shadow-lg" style={{ fontFamily: 'Cinzel, Georgia, serif' }}>
            SONGO
          </h1>
          <p className="text-amber-400/50 text-sm mt-1">Jeu de Semailles Africain</p>
        </div>

        {/* Card */}
        <div className="bg-black/35 backdrop-blur-md rounded-2xl border border-amber-700/15 p-5 space-y-5 shadow-2xl">

          <fieldset>
            <legend className="text-amber-400/50 text-[10px] font-bold uppercase tracking-widest mb-2">Mode de jeu</legend>
          ...
          {mode === 'pve' && (
            <fieldset>
              <legend className="text-amber-400/50 text-[10px] font-bold uppercase tracking-widest mb-2">Difficulte</legend>
          ...
          <button
            onClick={handleStart}
            className="w-full py-3 bg-gradient-to-b from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-amber-100 font-bold text-sm rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-[0.98] border border-amber-600/20"
          >
            Jouer
          </button>
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-b from-emerald-700 to-emerald-800 hover:from-emerald-600 hover:to-emerald-700 text-emerald-100 font-bold text-sm rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-[0.98] border border-emerald-600/20 flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onShowRules}
            className="w-full py-2.5 text-amber-400/40 hover:text-amber-300/60 text-xs font-semibold rounded-xl bg-white/5 hover:bg-white/8 transition-all border border-amber-800/10"
          >
            Consulter les regles
          </button>
        </div>

        <p className="text-center mt-5 text-amber-600/25 text-[10px]">
